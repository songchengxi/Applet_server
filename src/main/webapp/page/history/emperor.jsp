    ...
    <script type="text/javascript">
        ...
        app.controller(
                ...
                function ($rootScope, $scope, $http) {
                    ...
                    //初始化帝王信息
                    $http({
                        url: '${basePath}/history/getEmperor.do?id=<%=id%>',
                        method: 'POST'
                    }).then(function (rows) {
                    ...
                    $scope.save = function () {
                        ...
                        $http({
                            url: '${basePath}/history/saveEmperor.do',
                            method: 'POST',
                            data: $scope.data
                        }).then(function (r) {
                            //保存成功后更新数据
                    ...
                    $scope.del = function (id) {
                        $http({
                            url: '${basePath}/history/deleteEmperorById.do?id=' + id,
                            method: 'POST'
                        }).then(function (r) {
                            //删除成功后移除数据
                    ...
                    $scope.get = function (id) {
                        $http({
                            url: '${basePath}/history/getEmperorById.do?id=' + id,
                            method: 'POST'
                        }).then(function (data) {
                            data = data.data;
                            for (var i in $scope.rows) {
...
<table cellspacing="1" style="background-color: #a0c6e5">
    <tr>
        ...
        <td>介绍：</td>
        <td><textarea ng-model="data.introduce" cols="50" rows="5"></textarea></td>
    </tr>
</table>
<table cellspacing="1" style="background-color: #a0c6e5">
